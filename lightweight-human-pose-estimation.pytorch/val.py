...
import torch
import sys
# sys.path.append('/Users/mac/fivv/2D-3D/latest/lightweight-human-pose-estimation.pytorch/datasets')
import datasets
...
def evaluate(labels, output_name, images_folder, net, multiscale=False, visualize=False):
    ...
    dataset = datasets.coco.CocoValDataset(labels, images_folder)
    coco_result = []
